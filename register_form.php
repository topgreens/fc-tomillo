...
<section class="page-section" id="register">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img class="" src="img/people_connect1.png" alt="" style="max-height:200px;padding: 35px;">
            </div>
        ...
        <form name="sentRegister" id="registerForm" novalidate="novalidate" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="row">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-xl" name="newUser" style="margin-top: 20px;">Registrar</button>
            </div>
        </div>
    </div>
  </form>
